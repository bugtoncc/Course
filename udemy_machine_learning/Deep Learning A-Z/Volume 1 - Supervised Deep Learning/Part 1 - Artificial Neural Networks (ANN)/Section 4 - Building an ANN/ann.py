...
# Part 3 - Making the preditions and evaluating the model
...
"""
# Prediting one observation
hw = np.array([[0, 0, 600, 1, 40, 3, 60000, 2, 1, 1, 50000]])
#hw = np.array([[0, 0, 619, 1, 42, 2, 0, 1, 1, 1, 101348.88]])
hw = sc.transform(hw)
